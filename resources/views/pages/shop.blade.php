...
@section('content')
    ...
    <div class="col s12 item__shop__form">
      ...
      <div class="input-field col s12 item__shop__form hidden">
      <input id="first_name" name="hidden_item" type="text" class="validate" value="Электронный и бумажный сертификат от Агентства инновационного развития о прохождении курса обучения по программе «Основы технологического предпринимательства»">
      </div>
    </div>
      <p>* В сертификате указывается ФИО получателя, даты прохождения курса, тематика мастер-классов, количество часов – 24. Сертификат будет отправлен на электронную почту, указанную при покупке, в течение 5 рабочих дней после участия в мероприятии. Бумажный сертификат выдается в последний день проведения мероприятия</p>
    </div>
    <div class="modal-footer">
    ...
    <div class="card-stacked giti">
    <div class="card-content">
      <p class="magad2">Сертификат о дополнительном образовании от ведущего московского вуза (Национальный исследовательский университет «Московский авиационный институт»)</p>
    ...
    <div class="col s12 item__shop__form">
      ...
      <div class="input-field col s12 item__shop__form hidden">
      <input id="first_name" name="hidden_item" type="text" class="validate" value="Сертификат о дополнительном образовании от ведущего московского вуза (Национальный исследовательский университет «Московский авиационный институт») о прохождении курса обучения по программе «Основы технологического предпринимательства»">
      </div>
    </div>
