...
@section('content')
    ...
    <div class="input-field col s12 item__shop__form">
      ...
      <div class="input-field col s12 item__shop__form">
        <textarea id="textarea1" class="materialize-textarea validate" name="orderDetails" type="text">Электронный и бумажный сертификат от Агентства инновационного развития о прохождении курса обучения по программе «Основы технологического предпринимательства»</textarea>
